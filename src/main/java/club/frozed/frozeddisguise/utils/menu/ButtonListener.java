package club.frozed.frozeddisguise.utils.menu;

import club.frozed.frozeddisguise.FrozedDisguise;
import club.frozed.frozeddisguise.utils.menu.pagination.PaginatedMenu;
...
public class ButtonListener implements Listener {
        ...
        if (openMenu != null) {
            ...
            if (openMenu.getButtons().containsKey(event.getSlot())) {
                ...
                if (event.isCancelled()) {
                    Bukkit.getScheduler().runTaskLater(FrozedDisguise.getInstance(), () -> player.updateInventory(), 1L);
                }
            } else {
    ...
    public void onInventoryClose(InventoryCloseEvent event) {
        ...
        player.setMetadata("scanglitch", new FixedMetadataValue(FrozedDisguise.getInstance(), true));
    }
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        if (player.hasMetadata("scanglitch")) {
            player.removeMetadata("scanglitch", FrozedDisguise.getInstance());
